...
import FinancialRations from '../components/FinancialRations';

import { properties, financialData, incomeVsExpensesData, rentCollection, rentCollectionTrend, taxPayments, expenses, expenseDistribution, bankAccounts, taxDocuments, paymentsSample } from '../data/data';
            ...
            <div className="p-6 space-y-6">
                ...
                <Tabs defaultValue="overview" className="space-y-6">
                        ...
                        <CardContent>
                            <div className="overflow-x-auto">
                                <table className="w-full border-collapse">
                                    ...
                                    <tbody>
                                        {paymentsSample.map((payment, index) => (
                    ...
                    <TabsContent value="analytics" className="space-y-6">
                        ...
                        {/* Financial Ratios */}
                        <FinancialRations financialData={financialData} />
