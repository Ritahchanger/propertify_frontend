...
const PropertiesTable: React.FC<PropertiesTableProps> = ({
  ...
  const getUnitStatusCounts = (estate: Estate) => {
    const occupied = estate.units.filter(
      (unit) => unit.status === "occupied"
    ).length;
    const vacant = estate.units.filter(
      (unit) => unit.status === "vacant"
    ).length;
    const maintenance = estate.units.filter(
    ...
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage all your properties, view details, edit information, or
              ...
              {filteredEstates.map((estate) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>{getUnitStatusBadges(estate)}</TableCell>
                    <TableCell>
                      <div
                    ...
                    <TableCell>
                      ...
                      {occupied > 0 && (
                        <div className="text-xs text-green-600">
                          KSh{" "}
                          {Math.round(totalRevenue / occupied).toLocaleString()}{" "}
                          avg/unit
                        </div>
                      )}
                    </TableCell>
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                ...
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  <div className="text-2xl font-bold text-gray-600">
                    {
                      selectedEstate.units.filter((u) => u.status === "vacant")
                        .length
                    }
                  </div>
